...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xnso-ds.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xnso-ds.containers.anotherwebservice.com/
...
```
git clone git@github.com:KingKaonix/container-xnso-ds.git
cd container-xnso-ds
```
...
```
docker attach container-xnso-ds
```
